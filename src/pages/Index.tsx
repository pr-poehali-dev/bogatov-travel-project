...
const BENEFITS = [
  { icon: "Flame", title: "Мощный драйв", text: "От простых маршрутов по прямой, до мощного драйва — грязь, броды, крутые подъёмы. Настоящее приключение без купюр." },
  { icon: "Shield", title: "Полная безопасность", text: "Инструктаж, экипировка, сопровождение опытного гида на каждом метре." },
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center" style={{ minHeight: "calc(100vh - 160px)" }}>
          ...
          <div className="flex justify-center">
            <div style={{
              ...
              <img
                src="https://cdn.poehali.dev/projects/2eb621eb-507b-49ef-8fd5-40538caa0018/files/67d06abe-e662-412e-b051-4a20943f4d64.jpg"
                alt="Quad bike"
